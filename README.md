...
The following Gradle issues are relevant:
...
[Reposilite](https://reposilite.com/) acts as a caching Maven repository proxy and is
[configured](reposilite/config.json) to mirror the following upstream repositories:
...
Other projects might have `GRADLE_LIBS_REPO_OVERRIDE` set to https://maven-mirror.internal/gradle-libs.
